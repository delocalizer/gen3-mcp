...
class TestSchemaManager:
    """Test SchemaManager core functionality

    Focuses on schema-specific error scenarios (invalid data, cache behavior).
    """
    ...
    async def test_invalid_schema_handling(self, mock_client):
        ...
        mock_client.get_json.return_value = {}  # Empty schema
        manager = SchemaManager(mock_client)
...
class TestSchemaExtract:
    """Test schema extract creation and functionality"""

    @pytest.mark.asyncio
    async def test_extract_creation_success(self, schema_extract):
    ...
    @pytest.mark.asyncio
    async def test_entity_structure(self, schema_extract):
    ...
    @pytest.mark.asyncio
    async def test_serialization(self, schema_extract, reference_extract_json):
    ...
    @pytest.mark.asyncio
    async def test_to_json_method(self, schema_extract):
    ...
    @pytest.mark.asyncio
    async def test_dict_interface(self, schema_extract):
    ...
    @pytest.mark.asyncio
    async def test_type_checking(self, schema_extract):
        """Test type properties of SchemaExtract"""
        assert isinstance(schema_extract, dict)
        assert isinstance(schema_extract, SchemaExtract)

    def test_empty_extract_creation(self):
...
class TestSchemaProcessing:
    """Test schema processing logic for fields, relationships, and summaries"""
...
class TestSchemaManagerBehavior:
    """Test singleton factory and integration behavior"""
    ...
    def test_singleton_factory_cache_clear(self):
