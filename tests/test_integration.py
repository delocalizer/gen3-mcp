...
from gen3_mcp import Gen3Config, Gen3Client, Tools
...
def test_simplified_imports():
    ...
    from gen3_mcp.config import setup_logging, gen3_info, gen3_endpoints
    
    # Test individual modules
    import gen3_mcp.config
    import gen3_mcp.client  
    import gen3_mcp.service
    import gen3_mcp.query
    import gen3_mcp.tools
    import gen3_mcp.auth
    import gen3_mcp.exceptions
...
def test_config_integration():
    ...
    from gen3_mcp.config import gen3_info, gen3_endpoints, gen3_validation_guide
...
async def test_caching_integration(mock_client, config):
    ...
    service.clear_cache()
    schema3 = await service.get_full_schema()
